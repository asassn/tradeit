...
2. **The denominator has been run, its dating rule was found broken on 30.7% of
   ...
   curve has been built and read (§7be)** — and the reading limits what it can be
   used for: it holds **no exchange-listing evidence before 2002**, so it cannot
   evaluate a vendor's 1998–2002 delisted coverage, which is the window that
   matters most here. Closing that needs the document-parsing pass or a
   non-EDGAR listing source, not another vendor question. See milestone 0a.
...
| 8 | Re-run the gate against `research-01` | **RUN AGAIN 2026-09-12: `PARTIALLY_SURVIVORSHIP_CORRECTED`** — 8,079 of 21,618 dated Exchange Act exits priced (37.4%), 65.6% of those whose identity resolves, 91% of held series recording the death, 30/30 controls. The grade moved because the owner adopted §5's denominator that day, not because the corpus changed that day; the previous reading (8.3%) is published beside it and the standing rule did not lift (§7e). Priced dated exits rose 5,423 → 8,079 in a week. Earlier: **RUN TWICE 2026-09-01. Result both times: `SURVIVOR_BIASED`.** First: 590 of 29,180 dated exits priced (2.02% / 0.65%). After a bounded coverage push widening the window to 1998–2005 — 892 issuers, 1,874,666 price facts — **792 exits priced (2.71% / 0.87%) and the grade did not move.** 30/30 controls passed and did not rescue it, exactly as designed. Reported with limitations, not asserted | none |
