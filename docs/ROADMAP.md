...
| — | **Strategy Definition / Builder Architecture** | **Specified, not built.** [`STRATEGY_BUILDER.md`](STRATEGY_BUILDER.md) is written; no strategy object, version or lifecycle exists in code. Follows the multi-timeframe gate; **must complete before Phase 7** |
