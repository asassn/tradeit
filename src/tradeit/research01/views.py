...
README: tuple[tuple[str, str, str], ...] = (
    ...
    (
        ...
        "these limitations: coverage is thinnest in the oldest years (25.4% for "
        "1998), so "
        ...
        "recorded are not caught; results measured before that date must be "
        "re-run; and 1,206 priced exits rest on vendor_symbol identity rather "
        "than a ticker read from a filing. Evidence is still not profitability: "
        "pre-registration and "
        "out-of-sample tests decide what a result is worth. The decision and "
        "its limitations are recorded in EDGAR_DELISTING_DENOMINATOR.md section "
        "7e. "
    ...
    (
        ...
        "974,295 of them (2.42%), after Sharadar's printed close settled 1,151 "
        "such splits into security_split_price_verdicts. A raw "
